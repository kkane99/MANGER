...
class RNN_SD_Agent(nn.Module):
    ...
    def forward(self, inputs, hidden_state, update_metric = None):
        ...
        if update_metric is None:
            ...
            q = q*update_metric + q*(1-update_metric).detach() + local_q*0.1
            # q = q.detach() + 0.1*(local_q*update_metric + q*(1-update_metric))
